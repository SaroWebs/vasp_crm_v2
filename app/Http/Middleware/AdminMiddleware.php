...
class AdminMiddleware
{
     ...
     * 2. User has internal role (super-admin, admin, manager, team-lead, developer, support-agent, employee)
    ...
    public function handle(Request $request, Closure $next): mixed
    {
        ...
        $internalRoles = ['super-admin', 'admin', 'manager', 'team-lead', 'developer', 'support-agent', 'employee', 'hr', 'sales'];
