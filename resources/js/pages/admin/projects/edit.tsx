...
export default function EditProject({
    ...
    const { data, setData, patch, processing, errors, transform } = useForm<ProjectFormData>({
        name: project.name ?? '',
        code: project.code ?? '',
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Update project information and team setup.</p>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="budget" type="number" step="0.01" value={data.budget} onChange={(e) => setData('budget', e.target.value)} />
                            </div>
