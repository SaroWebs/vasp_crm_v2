            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Review and manage recent alerts.</p>
                    </div>
                    <Button onClick={markAllAsRead} disabled={counts.unread === 0}>
                        Mark All As Read
                    </Button>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Badge variant="destructive">Unread: {counts.unread}</Badge>
                        ...
                        notifications.data.map((notification) => (
                            <div
                                ...
                                className={`flex items-start justify-between gap-3 border-b p-4 last:border-b-0 ${
                                    notification.target_url ? 'cursor-pointer hover:bg-muted/40' : ''
                                }`}
                                onClick={() => openNotificationTarget(notification.target_url)}
                            >
